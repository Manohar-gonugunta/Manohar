...
public class question3{
	...
	public static void main(String[] args) {
		...
		employees.add(new Employee(1, "Manohar","IT",56000));
        employees.add(new Employee(4, "bannu","IT",50000));
        employees.add(new Employee(3, "gonugunta","IT",30000));
        employees.add(new Employee(2, "ABCD","IT",90760));
        employees.add(new Employee(4, "xyz","IT",67000));
